...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    },
    {
      ...
      children: [
        {
          path: 'reports/trip/tanker-wise',
          title: 'Tanker Wise',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/indent-wise',
          title: 'Indent Wise',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/mpc-wise',
          title: 'MPC Wise',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/alert-report',
          title: 'Alert Report',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/travel-report',
          title: 'Travel Report',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/distance-report',
          title: 'Distance Report',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/monthly-report',
          title: 'Monthly Report',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/halt-report',
          title: 'Halt Report',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/e-lock-report',
          title: 'E-lock Report',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/lid-report',
          title: 'Lid Report',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/trip-summary',
          title: 'Trip Summary',
          type: 'link',
          dirchange: false,
        },
        {
          path: 'reports/trip/cart-report',
          title: 'Cart Report',
          type: 'link',
          dirchange: false,
        },

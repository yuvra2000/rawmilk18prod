...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    { headTitle: 'OVERVIEW' },
    {
      ...
      dirchange: false,
      children: [
        { path: 'overview/', title: 'Home', type: 'link', dirchange: false },
        { path: 'overview/view-indent', title: 'View Indent', type: 'link', dirchange: false },
        { path: 'overview/trip-dashboard', title: 'Trip Dashboard', type: 'link', dirchange: false },
        { path: 'overview/inventory', title: 'Inventory', type: 'link', dirchange: false },
        { path: 'overview/projection', title: 'Projection', type: 'link', dirchange: false },
        { path: 'overview/load-planning', title: 'Load Planning', type: 'link', dirchange: false },
        { path: 'overview/document-wallet', title: 'Document Wallet', type: 'link', dirchange: false },
        { path: 'overview/cart-dashboard', title: 'Cart Dashboard', type: 'link', dirchange: false },
      ],
    },

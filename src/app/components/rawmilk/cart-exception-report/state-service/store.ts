...
import { CartExceptionReportService } from '../cart-exception-report.service';
...
export class CartReportExceptionStore {
  ...
  private cartReportExService = inject(CartExceptionReportService);
  ...
  async loadInitialData() {
    ...
    try {
      ...
      const res: any = await firstValueFrom(
        this.cartReportExService.initializePageData(vehicleParams, listParams),
      );
      if (
